...
Testing of a method for calibrating the AGC model to new images gave encouraging results.  The table shows *R*<sup>2</sup> for models fitted with a WorldView-3 Oct 2017 ("WV3 Aug 2017") image and calibrated to an additional two WorldView-3 images ("WV3 Oct 2017" and "WV3 Nov 2018"), and a mosaic of aerial imagery ("NGI April 2015").   
...
* **DigitalGlobe (now Maxmar)** - *WorldView-3 images* - [www.maxmar.com](http://www.maxar.com)
